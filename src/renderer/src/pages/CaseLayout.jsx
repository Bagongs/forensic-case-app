...
export default function CaseLayout({ title, showBack = false, children }) {
  ...
  const tab = (to, label) => {
    ...
    return (
      <Link
        to={to}
        className="relative 2xl:px-[140px] px-[70px] 2xl:py-5 py-3 text-sm font-semibold transition-all duration-300"
        style={{
          background: isActive
  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 py-6">
        <div className="absolute flex justify-end items-center -space-x-9 2xl:-space-x-10 mb-5 right-6 2xl:-right-105 2xl:mt-5">
